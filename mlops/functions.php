...
function scripts_setup(){
    ...
    wp_register_script( 'global', get_template_directory_uri() . '/js/global.js', array('jquery', 'match-height'), '1.1.7', true );
...
function html5blank_styles()
{
    ...
    wp_register_style('html5blank', get_template_directory_uri() . '/css/style.css', array(), '1.3.1', 'all');
...
function load_admin_style() {
    wp_register_style('style-admin', get_template_directory_uri() . '/css/style-admin.css', array(), '1.8', 'all');
